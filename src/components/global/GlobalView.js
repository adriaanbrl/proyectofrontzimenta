  ...
  return (
      <div className="container-fluid">
        ...
        >
          ...
          {/* Imagen 1 */}
          <div className="col-md-4 col-sm-4 tarjetas mb-4">
        ...
        <div className="row align-items-start mt-5 g-4">
          {/* Columna 1 */}
          <div className="col-12 col-md-6 d-flex flex-column"> {/* Añadido d-flex flex-column */}
            <div className="p-4">
              <h2 className="modern-title text-start mb-3 text-center">
            ...
            <img
                ...
                className="img-fluid w-100 tarjetas mb-4"
                alt="Imagen 1"
          ...
          <div className="col-12 col-md-6 d-flex flex-column"> {/* Añadido d-flex flex-column */}
            <div className="p-4">
              <h2 className="modern-title text-start text-center">
            ...
            <div className="row g-3 mt-auto"> {/* Añadido mt-auto */}
              {/* Imagen 2 */}
              <div className="col-12">
                <img
